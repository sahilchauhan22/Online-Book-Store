...
const LoginDialog = ({open, setOpen }) => {
    ...
    const [signup, setSign] = useState(signupIntitialValues);
                ...
                <Box style={{display : 'flex' ,height:'100%'}}>
                      ...
                      </Image>
                      {
                        ...
                        <Wrapper>
                                ...
                                <Text>By continuing , you agree to terms and condition</Text>
                                <LoginButton onClick={() => loginUser()}>Login</LoginButton>
                                <Typography style={{textAlign: 'center'}}>OR</Typography>
                                <RequestOTP>Request OTP</RequestOTP>
                                <CreateAccount onClick={() => toggleSignup()}>Create account</CreateAccount>
                        </Wrapper>
                      :
                        <Wrapper>
